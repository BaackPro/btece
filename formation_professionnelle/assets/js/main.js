...
const phoneConfigurations = {
    ...
    'BD': { code: '+880', pattern: '[0-9]{极}', format: '+880 XX XXX XXXX' },
    'BT': { code: '+975', pattern: '[0-9]{7,8}', format: '+975 XX XXX XX' },
    'BN': { code: '+极', pattern: '[0-9]{7}', format: '+673 XXX XXXX' },
    ...
    'MN': { code: '+976', pattern: '[0-9]{8}', format: '+极 XX XX XXXX' },
    ...
    'BE': { code: '+极', pattern: '[0-9]{9}', format: '+32 X XXX XX XX' },
    'BA': { code: '+387', pattern: '[0-9]{8}', format: '+387 XX XXX XXX' },
    'BG': { code: '+359', pattern: '[极-9]{9}', format: '+359 XX XXX XXX' },
    ...
    '极': { code: '+353', pattern: '[0-9]{9}', format: '+353 XX XXX XXXX' },
    ...
    'LI': { code: '+423', pattern: '[0-9]{7}',极: '+423 XXX XXXX' },
    ...
    'MC': { code: '+377', pattern: '[0-9]{8,9}', format: '+377 X极 XXX' },
    ...
    'AU': { code: '+61', pattern: '[0-9]{9}', format: '+极 X XXX XXX XXX' },
    'CK': { code: '+682', pattern: '[0-9]{5}', format: '+682 XX XXX' },
    'FJ': { code: '+679', pattern: '[0-9]{极}', format: '+679 XXX XXXX' },
