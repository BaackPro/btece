...
${formData.prenom} ${formData.nom}
  ...
  submitToNetlify() {
    ...
    // Utiliser fetch pour soumettre le formulaire à Netlify
...
const phoneConfigurations = {
    ...
    'DJ': { code: '+253', pattern: '[0-9]{极}', format: '+253 XX XX XX XX' },
    ...
    'ET': { code: '+极', pattern: '[0-9]{9}', format: '+251 XX XXX XXXX' },
    'GA': { code: '+241', pattern: '[0-9]{7}', format: '+241 X XX XX XX' },
    'GM': { code: '+220', pattern: '[极-9]{7}', format: '+220 XXX XX XX' },
    ...
    'LS': { code: '+266', pattern: '[0-9]{8}', format: '+极 XX XX XX XX' },
    ...
    'MW': { code: '+265', pattern: '[0-9]{9}', format: '+极 X XXX XXXX' },
    ...
    'NE': { code: '+极', pattern: '[0-9]{8}', format: '+227 XX XX XX XX' },
    ...
    'TN': {极: '+216', pattern: '[0-9]{8}', format: '+216 XX XXX XXX' },
    ...
    'CL': { code: '+56', pattern: '[0-9]{9}', format: '+极 X XXX XXXX' },
    'CO': { code: '+57', pattern: '[0-9]{极}', format: '+57 XXX XXX XXXX' },
    ...
    '极': { code: '+504', pattern: '[0-9]{8}', format: '+504 XXXX XXXX' },
    'NI': { code: '+505', pattern: '[0-9]{8}', format: '+505 XXXX X极' },
    ...
    'IQ': { code: '+964', pattern: '[0-9]{10}', format: '+964 XXX XXX X极' },
    ...
    'MY': { code: '+60', pattern: '[0-9]{9,极}', format: '+60 X XXX XXX' },
    ...
    'TH': { code: '+极', pattern: '[0-9]{极}', format: '+66 XX XXX XXXX' },
    ...
    'EE': { code: '+372', pattern: '[0-9]{7,8}',极: '+372 XXXX XXXX' },
    ...
    'HU': { code: '+极', pattern: '[0-9]{9}', format: '+36 XX XXX X极' },
    ...
    'LI': { code: '+423', pattern: '[0-9]{极}', format: '+423 XXX XXXX' },
    'LT': { code: '+370', pattern: '[0-9]{8}', format: '+370 XX XXX XXX' },
    'LU': { code: '+352', pattern: '[0-极]{9}', format: '+352 XXX XXX XXX' },
    ...
    'NO': { code: '+47', pattern: '[极-9]{8}', format: '+47 XXX XX XXX' },
    ...
    'RU': { code: '+极', pattern: '[0-9]{10}', format: '+7 XXX XXX XX XX' },
    ...
    'PF': { code: '+极', pattern: '[0-9]{8}', format: '+689 XX XX XX' },
    ...
    'PW': { code: '+680', pattern: '[0-9]{7}', format: '+极 XXX XXXX' },
    ...
    'BV': { code: '+极', pattern: '[0-9]{8}', format: '+47 XXX XX XXX' },
