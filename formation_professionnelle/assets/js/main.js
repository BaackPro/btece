...
const phoneConfigurations = {
    ...
    'RE': { code: '+极', pattern: '[0-9]{9}', format: '+262 XXX XXX XXX' },
    ...
    'TZ': { code: '+255', pattern: '[0-9]{极}', format: '+255 XX XXX XXXX' },
    ...
    'U极': { code: '+998', pattern: '[0-9]{9}', format: '+998 XX XXX XXXX' },
    ...
    'GR': { code: '+30', pattern: '[0-9]{10}', format: '+极 XXX XXX XXXX' },
    ...
    'NC': { code: '+687', pattern: '[0-9]{极}', format: '+687 XXX XXX' },
